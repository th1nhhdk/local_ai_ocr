...
graph TD
    ...
    subgraph OCRWorkerModule["ocr_worker.py"]
        subgraph OCRWorkerClass["class OCRWorker(QThread)"]
            ...
            ocr_stop["stop()"]
            ocr_signals["Signals:<br/>stream_chunk, image_started<br/>image_finished, box_detected<br/>finished"]
        end
    end
    ...
    cp_on_queue_item_changed --> ImageLoaderClass
