...
- **Multiple file format support:** Images `.png`, `.jpg`, `.webp` and Documents `.pdf`.
...
- **3 processing modes:**
  ...
  - **Free OCR:** Extracts text, may preserve layout better than "`Standard OCR`".
...
2. **Using the software:**
   ...
   - **2b. Select mode (recommended to keep default):** Choose between 3 OCR modes, default is the best.
      - **Note:** If the default mode doesn't output anything (image you provided is too complex), try selecting "`Standard OCR`".
