...
# Force CPU-only
$env:CUDA_VISIBLE_DEVICES = "-1" # NVIDIA disable
$env:ROCR_VISIBLE_DEVICES = "-1" # AMD disable
$env:GGML_VK_VISIBLE_DEVICES = "-1" # Vulkan disable
...
Write-Host "Starting Ollama (CPU-Only)..."
